...
const loadDataFromLocalStorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>CloneGPT</h1>
                            <p>Start a conversation and explore the power of AI.<br>Your chat history will de displayed here</p>
                        </div>`
...
const getChatresponse = async(incomingChatDiv) => {
    ...
    try {
        ...
        pElement.textContent = "Oops! Somehitng went wrong while retrieving the response. Please try again"
    }
